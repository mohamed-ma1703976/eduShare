            ...
            return (
              <ButtonBase component="div" sx={{ textDecoration: "none", color: "inherit" }} key={a.id}>
                <motion.div initial="initial" animate="animate" variants={cardVariants}>
                  <Card sx={{ display: "flex", flexDirection: "column", Height: "100", cursor: "pointer", Width: "300px", margin: "10px 20px 0 0", backgroundColor: "#f5f5f5" }}>
                    <motion.div variants={imageVariants}>
                      <CardMedia component="img" height="100" image={coverPictureUrl} alt={a.attributes.name} style={{ maxHeight: "200px", width: "1000px" }} />
                    </motion.div>
