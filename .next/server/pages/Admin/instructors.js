...
function InstructorTable() {
    ...
    const [statusChange, setStatusChange] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)();
    const [instructors, setInstructors] = react__WEBPACK_IMPORTED_MODULE_3___default().useState([]);
    const [loading, setLoading] = react__WEBPACK_IMPORTED_MODULE_3___default().useState(true);
    console.log(instructors);
    react__WEBPACK_IMPORTED_MODULE_3___default().useEffect(()=>{
        const fetchInstructors = async ()=>{
            const instructorCollection = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_5__.collection)(_Firebase_Firebase__WEBPACK_IMPORTED_MODULE_6__.db, "Instructor");
    ...
    async function handelDelete(id) {
        if (confirm("Are you sure you want to continue?")) {
            try {
                const instructoreRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_5__.doc)(_Firebase_Firebase__WEBPACK_IMPORTED_MODULE_6__.db, "Instructor", id);
                await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_5__.deleteDoc)(instructoreRef);
                router.reload();
            } catch (err) {
                console.log(err);
            }
    ...
    async function handelClick(id) {
        ...
        try {
            const instructorRef = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_5__.doc)(_Firebase_Firebase__WEBPACK_IMPORTED_MODULE_6__.db, "Instructor", id);
            await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_5__.updateDoc)(instructorRef, collectedData);
            router.reload();
        } catch (err) {
            console.log(err);
        }
                        ...
                        children: instructors?.map((s)=>{
                            return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_1__.TableRow, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_1__.TableCell, {
                                        align: "right",
                                        children: s.attributes.specialization
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_1__.TableCell, {
                                        align: "right",
                                        children: [
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InstructorTable);
...
/* harmony import */ var _component_Signup_InstructorTable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(467);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5692);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_mui_material__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_5__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_component_Navbar__WEBPACK_IMPORTED_MODULE_1__, _component_Sidebar__WEBPACK_IMPORTED_MODULE_2__, _component_Signup_InstructorTable__WEBPACK_IMPORTED_MODULE_3__]);
([_component_Navbar__WEBPACK_IMPORTED_MODULE_1__, _component_Sidebar__WEBPACK_IMPORTED_MODULE_2__, _component_Signup_InstructorTable__WEBPACK_IMPORTED_MODULE_3__] = __webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__);
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_4__.Stack, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_mui_material__WEBPACK_IMPORTED_MODULE_4__.Box, {
                        flexGrow: 1,
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_component_Signup_InstructorTable__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {})
                    })
                ]
            })
        ]
...
var __webpack_exports__ = __webpack_require__.X(0, [6216,7568], () => (__webpack_exec__(7000)));
