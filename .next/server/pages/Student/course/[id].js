...
const CoursePage = ({ course  })=>{
    ...
    if (!course || router.isFallback) {
        return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_component_Loading___WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {});
    }
    const [rating, setRating] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0);
    const [enrollButtonDisabled, setEnrollButtonDisabled] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const [showReg, setShowReg] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    const [israted, setIsRated] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
    ...
    const [enrolledCourse, setEnrolledCourse] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
        registerdcourses: []
    });
    const [instructorCourses, setInstructorCourses] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
        myCourse: []
    });
    const [courseRating, setCourseRating] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
        rates: course.rates
    });
...
async function getStaticPaths() {
    const courseCollection = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_6__.collection)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_6__.getFirestore)(), "Course");
    const courseSnapshot = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_6__.getDocs)(courseCollection);
...
async function getStaticProps({ params  }) {
    const courseDoc = (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_6__.doc)((0,firebase_firestore__WEBPACK_IMPORTED_MODULE_6__.getFirestore)(), "Course", params.id);
    const courseSnap = await (0,firebase_firestore__WEBPACK_IMPORTED_MODULE_6__.getDoc)(courseDoc);
